...
from ashare_mainline_radar.strategy_backtest import render_strategy_backtest, run_strategy_backtest
...
def main() -> int:
    ...
    report = run_strategy_backtest(config, a_klines, a_instruments, hk_klines, hk_instruments)
